...
<script>
  ...
  gtag('config', 'UA-132426947-2');
	...
	<meta name="description" content=" Detailed description of <?php echo $page_sub2; ?> with description of subgroup under this with images and videos available here."/>
    ...
    <title><?php echo $page_sub2; ?>|Biodiversity of West Bengal</title>
  </head>
  <body>
...
<div id="containerR">
<?php  $query = mysqli_query($db,"select * from sub25 where sub2='".mysqli_real_escape_string($db, $page_sub2)."'");
		$rows = mysqli_fetch_assoc($query);
		$sub2 = $rows['sub2'];
		
		?>
		<span  id="<?php echo $sub2; ?>"></span>
		<hr>
	<h1 class="shadow" style="padding:10px;margin-top:30px;"><b><?php echo "$sub2"; ?></b></h1><br>
		<hr>
	...
	<div class="row">
		...
		$description = $row1['description'];
		 ...
		 ?>
				   ...
				   <a href="sub3.php?sub2=<?php echo $sub21; ?>&sub25=<?php echo $name1; ?>#<?php echo $name1; ?>" > <img class="rounded-circle shadow" src="assets/image/<?php echo "$image"; ?>" alt="Generic placeholder image" width="140" height="140" title="wildwingsindia"></a>
					<h3 style="text-align:left;"><?php echo "$name1"; ?></h3>
					<p><?php echo "$description"; ?></p>
					<p><a class="btn btn-secondary" href="sub3.php?sub2=<?php echo $sub21; ?>&sub25=<?php echo $name1; ?>#<?php echo $name1; ?>" role="button">View details &raquo;</a></p>
				  </div><!-- /.col-lg-4 -->
