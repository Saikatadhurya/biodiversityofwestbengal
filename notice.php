...
<script>
  ...
  <?php include("includes/header.php") ?>
	<br><br>
	  <main role="main">
<div id="notice">
<h1 text align="center" > NOTICE </h1>
...
$i=1;						
	   include('includes/connect.php');
									$query = mysqli_query($db,"select * from notice order by 1 DESC");
    ...
    <tr>
      ...
      <td><a href="noticepage.php?notice=<?php echo $notice;?>"><?php echo $notice;?></td>
    </tr>
    <?php
									}
								?>
