...
<div class="col-sm-3">
				...
				<div class="form-group">
				 <label>Choose Subsection2.5</label>
						<select class="form-control selUser" name="sub25" id="sub25"> 
...
if(isset($_POST['submit']))
{
	...
	else
	{
		...
		if (($_FILES["image"]["type"] == "image/gif") ||
			...
			$query = "INSERT INTO sub3 (name,sub25,image,description,sub2) VALUES('$sub3','$sub25','$imagename','$description','$sub2')";
