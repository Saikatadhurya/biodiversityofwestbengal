...
<div class="col-lg-15">
	...
	<div class="col-sm-3">
		...
		<div class="form-group">
				...
				<div class="col-sm-10">
				<div class="form-group">
				<input class="form-control" name="description" type="text" placeholder="Enter Description(max 250 words)" maxlength="250" value="<?php echo $description;?>" required>
			</div>
		</div>
...
if(isset($_POST['update']))
{
	...
	else
	{
		...
		$update_query="update sub4 set date = '$date', pname = '$pname', place = '$place', district = '$district', description = '$description' where id = '$update_id'";
